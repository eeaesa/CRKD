...
class LAHeart_CrossMatch(Dataset):
    """LA Dataset"""
...
class LAHeart_PICK(Dataset):
    """ LA Dataset """

    def __init__(self, base_dir=None, mode='train',
                 num=None, transform=None, id_path=None):
        self._base_dir = base_dir
        self.transform = transform
        self.mode = mode
        self.sample_list = []
        ...
        # train_path = self._base_dir + 'LA_train.txt' # org
        # test_path = self._base_dir + 'LA_test.txt' # org
...
#-------------PICK----------------
class MaskGenerator:
    def __init__(self, input_size=96, mask_patch_size=16, mask_ratio=0.6):
    ...
    def __call__(self):
        ...
        mask = mask.repeat(self.mask_patch_size, axis=0).repeat(self.mask_patch_size, axis=1).repeat(
            self.mask_patch_size, axis=2)

        return mask
#-------------PICK----------------

class LAHeart_CRKD(Dataset):
    """LA Dataset"""
